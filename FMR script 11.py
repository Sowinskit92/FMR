...
if __name__ == "__main__":
    ...
    if Market_fundementals == True:
        ...
        #gen_mix["Solar"] = gen_mix.groupby(["Date", "SP"])[["Solar", "Solar (Embedded)"]].mean() # takes average between the two solar values in the data set as there's a slight discrepancy between the two
        print(gen_mix_table)
        if Load == True:
