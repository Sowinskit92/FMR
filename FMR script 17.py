...
if __name__ == "__main__":
    ...
    if kW_revenue == True:       
        ...
        non_flex_fuel_types = ["CCGT", "Wind", "Biomass", "NPSHYD", "INTELEC", "INTEW", "INTFR", "INTIFA2", "INTIRL",
                               "INTNED", "INTNEM", "INTNSL", "INTVKL", "COAL", "Non-PS Hydro", "Nuclear"]
        ...
        """This bit estimates capacities from units which have 0MW capacity yet made money in the BM, leading to
        infinite £/kW revenue
